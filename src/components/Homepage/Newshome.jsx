...
export default function Newshome() {
  const SPREADSHEET_URL =
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vQeH6GPT_zewQGOeZcDKZQowl7FVcSiQZr-JDSwSL9tnQpIGhI_2a8wk5YhTWMNRUxXTj5kZDxQ-b6T/pub?gid=1416863627&single=true&output=csv";
      ...
      <div className="w-full mx-auto mb-10">
        <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-xl font-bold font-glancyr uppercase tracking-wider text-[var(--black)]">
              What's New in Robotics...
            </h2>
            <p className="text-3xl sm:text-4xl lg:text-5xl font-glancyr text-[var(--black)] leading-tight">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-base text-[var(--black)] font-sfpro leading-relaxed">
