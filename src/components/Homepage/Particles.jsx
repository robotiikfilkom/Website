...
const Particles = ({
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      // 🖱️ Gerakkan partikel mengikuti mouse (smooth)
      if (moveParticlesOnHover) {
        const targetX = -mouseRef.current.x * particleHoverFactor * 10.0;
        const targetY = -mouseRef.current.y * particleHoverFactor * 10.0;
