          ...
          <div className="absolute bottom-4 left-4 right-4">
            <div className="relative bg-white/10 backdrop-blur-md opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-xl border border-white/20 p-4">
              <div className="flex flex-col gap-0 group-hover:gap-1">
                <h3 className="text-[var(--white)] text-xl font-bold drop-shadow-lg font-display transition-all duration-300 break-words">
                  {item.title}
                </h3>
      ...
      >
        <div className="flex flex-col md:flex-row items-start gap-8 md:gap-16">
          ...
          <div className="w-full md:w-2/3">
            <p className="text-2xl sm:text-3xl lg:text-4xl font-sfpro text-black/90 leading-tight">
        ...
        <div className="w-full md:w-auto flex-shrink-0">
          ...
          >
            <div className="relative w-28 h-6">
              <span
                className={`absolute font-glancyr transition-opacity duration-500 ${
